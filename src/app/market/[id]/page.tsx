                    ...
                    <div className="space-y-2 mb-3">
                      ...
                      >
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs font-bold font-mono text-terminal-amber">Technical Analysis</span>
                        </div>
                      </button>
          ...
          <div className={cn(
            ...
            <div className="w-full space-y-1">
              ...
              <div className="flex items-center gap-2 text-[10px] font-mono text-muted-foreground">
                ...
                <span className="animate-pulse" style={{ animationDelay: '0.4s' }}>Running signal detection...</span>
              </div>
              <div className="flex items-center gap-2 text-[10px] font-mono text-muted-foreground">
                <div className={cn(
                  "w-2 h-2 rounded-full animate-pulse",
      ...
      {showAnalysisModal && (analysisMode === 'ai' || analysisMode === 'math') && aiAnalysis && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-sm">
          <div className={cn(
              ...
              <div className="flex items-center gap-2">
                {analysisMode === 'ai' ? (
                  <>
                    ...
                    <span className="text-terminal-amber font-mono text-sm uppercase">Technical Analysis</span>
                  </>
                ) : (
                  <>
            ...
            <div className="border-t border-border p-3 bg-black">
              <div className="flex items-center justify-between text-[9px] text-muted-foreground font-mono">
                <span>Model: {analysisMode === 'ai' ? 'PolyTerminal-LocalAnalysis-v1' : 'Monte Carlo GBM'}</span>
